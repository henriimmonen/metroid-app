...
function Text () {
  return (
    <div className="body-text">
      ...
      <p>
        One of the more popular Nintendo Entertainment System video games is Metroid.
        A side scrolling, non-linear game where you shoot space pirates, collect power-ups and make your way through exciting alien landscapes.
        It has since become a continuing series with over 14 games and more on the way.
        First released in 1986, it has borrowed and in turn influenced other Nintendo staples such as the Super Mario and the Legend of Zelda series.
      ...
      <p>
        ...
        Some early examples of story-based arcade games include Dragons Lair.
        Games changed gradually into more complex in terms of the story when computing power rose and personal computers became more widely available.
        Text-based games like Zork were among the first to use storylines.
        Even though the games didn't use graphics, the characters had more depth than a simple sprite that the player controlled.
      </p>
      <h2>
        Women in Space: Metroid and Alien
      </h2>
      <p>
        In Metroid-games you play as Samus Aran, a space bounty hunter who is set to save the world usually in alliance with the Chozo, a friendly species.
      ...
      <p>
        ...
        There are some moments in the Metroid franchise, where Samus is depicted in a more sexualized way but in majority of the games, her sex and gender are a side note.
        There are some moments however with maternal themes (including a baby metroid) and these themes are interestingly used also in some movies in the Alien franchise.
        It shows us a different side of Samus and add a level of depth to the character, that is not shown in many of the games.
        Most of the time the role of the hero is shown as a stoic killer with little to no emotions or conflicts.
        For the player this doesn't give a lot of room to identify with the character.
        Humans tend to be complex and usually successful portrayal of this creates better gaming experiences like in the Last of Us.
      </p>
      <h2>
        Darker Shades
      </h2>
